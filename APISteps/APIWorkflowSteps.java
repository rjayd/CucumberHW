...
public class APIWorkflowSteps {
    ...
    public void the_employee_id_is_stored_as_a_global_variable_to_be_used_for_the_other_calls(String empID) {
    ...
    @Then("the retrieved employee id {string} should match the globally stored employee_id")
    public void the_retrieved_employee_id_should_match_the_globally_stored_employee_id(String employeeIdFromResponse) {

       String temp_EmpId =  response.jsonPath().getString(employeeIdFromResponse);
        Assert.assertEquals(employee_id, temp_EmpId);
    }
    @Then("the retrieved data at the {string} object matches the data used to create an employee with employee_id {string}")
    public void the_retrieved_data_at_the_object_matches_the_data_used_to_create_an_employee_with_employee_id
    ...
    public void a_request_is_prepared_for_creating_an_employee_with_dynamic_data(String emp_firstname, String emp_lastname, String emp_middle_name, String emp_gender, String emp_birthday,
